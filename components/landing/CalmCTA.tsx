                ...
                <div className="relative z-10 text-center max-w-2xl mx-auto">
                    ...
                    <Magnetic strength={60}>
                        <button
                            ...
                            className="relative group overflow-hidden bg-white text-black px-12 py-6 rounded-full font-bold text-lg md:text-xl tracking-wide transition-transform duration-300 hover:scale-105"
                        >
